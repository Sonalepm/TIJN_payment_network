...
.butn{
    ...
    <form action="acc_summary.php" method="POST">
    <table align="center">
        ...
        <table align="center" class = "butn"><tr><td colspan="2" align='center' ><input type="submit" name="summary_date" value="Go" class="addstaff_button"/></td>
        </tr>
        </table>
          </form>  
